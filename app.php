...
<?php
$DATO = $parqueo->validarIngresoSalida("SELECT COUNT(*) FROM BDMUF.TBFACIECAJ WHERE ( USCODUSUA = 'SISDIEGOG' OR USCODUSUAR = 'SISDIEGOG' ) AND CAFECCAJA = 20170209 AND MOCODMOTIV <> 102");
echo $DATO;
