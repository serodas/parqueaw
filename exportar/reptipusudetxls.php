...
<html>
    ...
    <body>
        ...
        echo "<thead>";
            echo "<tr>";
                echo "<th colspan=\"7\" style=\"text-align: center;\">COMFAMILIAR RISARALDA</th>";
            echo "</tr>";
            echo "<tr>";
                echo "<th colspan=\"7\" style=\"text-align: center;\">Tipo de Usuario - Detallado</th>";
            echo "</tr>";
            echo "<tr>";
        ...
        while ( $rs = odbc_fetch_array($reg) ) {
            ...
            echo "<tr>";
                ...
                echo "<td>" . $rs[odbc_field_name($reg, 6)] . "</td>";
                echo "<td>" . $rs[odbc_field_name($reg, 7)] . "</td>";
                echo "<td>" . $rs[odbc_field_name($reg, 8)] . "</td>";
            echo "</tr>";
