<script>
    function accion(cod){
        window.location.href="app.php?web=motivo&id="+cod;
    }
    ...
    <div class="row-fluid">
        <div class="span3">
            ...
            if ( isset( $_POST['actualiza'] ) ) {
                ...
                $tabla = $parqueo->limpiarEntradas($_POST['tabla'], 25);
            ...
            if( odbc_num_rows($consulta) ) {
                ...
                $tabla = $res[odbc_field_name($consulta, 2)];
            ...
            <form action="" method="POST">
                ...
                ?>
                <label>Tabla</label>
                <input type="text" class="span12" name="tabla" maxlength="25" value="<?php echo $tabla; ?>" >
        ...
        <div class="span9">
            <h1>
                <a href="app.php?web=motivo" class="btn btn-primary" title="Nuevo registro">
                    <i class="icon-plus icon-white"></i>
                </a> 
                Motivo
            </h1>
            <?php
            $sql = " select m.id, m.tabla, m.nombre, m.criterio, m.estado
                from motivo m ";
            $encabezados = "Cod.,Tabla,Nombre,Criterio,Est";
            $parqueo->tabla($sql, $encabezados, 'accion', 'motivo');
            ?>
        </div>
    </div>
</div>