    ...
    <div class="row-fluid">
                ...
                if ( trim($_POST['placa']) == '' or trim($_POST['canumdocum']) == '' or trim($_POST['canumdocum']) == 0 or trim($_POST['nombre']) == '' or strlen(trim($_POST['nombre'])) < 10  ) {
                    ...
                    if ( isset( $_POST['actualiza'] ) ) {
                        ...
                        $sentencia = " update vehiculos set nombre = '%s', tipousua = '%s', tipovehi = '%s', canumdocum = '%s', 
                            ...
                            equipo = '%s', dirip = '%s', feclim = '%s' where placa = '%s' ";
                        $sql = sprintf($sentencia, $nombre, $tipousua, $tipovehi, $canumdocum, $color, $estavehi, $estado, $login, $fecha, $hora, $equipo, $dirip, $feclim, $placa);
        ...
        //                        window.location.href="app.php?web=vehiculos";
                        ...
                        $sentencia = " insert into vehiculos (placa, nombre, tipousua, tipovehi, canumdocum, color, estavehi, estado, 
                            usuario, fecha, hora, equipo, dirip, feclim) values
                            ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s') ";
                        $sql = sprintf($sentencia, $placa, $nombre, $tipousua, $tipovehi, $canumdocum, $color, $estavehi, $estado, $login, $fecha, $hora, $equipo, $dirip, $feclim);
        ...
        <div class="span9">
            ...
            $encabezados = "Placa,Identidad,Nombre completo,Dependencia / tipo,Vehiculo,Estado,Col,Fec lim,Est";
