...
<h2>
    Ingresos totales por dia, cajero y actividad
    <a href="exportar/repingdiaxls.php" target="_blank" class="btn btn-warning" title="Descargar informacion">
        <i class="icon-download-alt icon-white"></i>
    </a>
</h2>
    
<?php
    $sql = "select g.uscodusuar, g.usnomusuar, a.mrfecate, p.nombre, d.acdesactiv, count(*), sum(b.manumcant), sum(b.manumval) 
        ...
        where a.cacodcenat in ('PQ1', 'PQ2', '301')
            ...
            and a.mocodmotiv = '14'
            and d.actipo = 'P'
        group by g.uscodusuar, g.usnomusuar, p.nombre, a.mrfecate, d.acdesactiv
        order by a.mrfecate ";
