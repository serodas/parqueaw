<script>
    function accion(cod){
        window.location.href="app.php?web=tipousua&id="+cod;
    }
</script>
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span3">
            ...
            $sqlSp = " select nombre, criterio, estado from motivo where id = %d and tabla = 'tipousua' ";
        ...
        <div class="span9">
            <h1>
                <a href="app.php?web=tipousua" class="btn btn-primary" title="Nuevo registro">
            ...
            $sql = " select m.id, m.nombre, m.criterio, m.estado
                from motivo m where tabla = 'tipousua' ";
