<script>
    function accion(cod){
        window.location.href="app.php?web=estavehi&id="+cod;
    }
</script>
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span9">
            <h1>
                <a href="app.php?web=estavehi" class="btn btn-primary" title="Nuevo registro">
                    <i class="icon-plus icon-white"></i>
                </a> 
                Registro tipo de estado del Veh&iacute;culo.
            </h1>
            <?php
            $sql = " select m.id, m.nombre, m.criterio, m.estado
                from motivo m where tabla = 'estavehi' ";
