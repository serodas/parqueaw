<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            $encabezados = "Placa,Identidad,Nombre completo,Dependencia,Tipo usuario,Vehiculo,Estado,Col,Fec lim,Aut,Procedencia,E";
                ...
                if( odbc_num_rows( $reg ) ) {
                    ...
                    while ( $res = odbc_fetch_array($reg) ) {
                        ...
                        $tabla.= ">";
                            ...
                            $tabla.= "<td>" . ucwords(strtolower($res[odbc_field_name($reg, 10)])) . "</td>";
